    ...
    <div class="menu_nav_1" id="nav_1_id">
        ...
        <div class="rubrique_1">
            ...
            <div class="container_conn_insc">
                ...
                <div class="connection_inscription_bloc" id="inscri"><a href="/?dest=inscription&id_insc=<?php echo $uuid;?>">
...
<div class="nav_2" id="nav_2_id">
        ...
        <span> 
            <a class="insc_conn_nav2 inscription" href="/?dest=inscription&id_insc=<?php echo $uuid;?>">  
                    <svg class="svg_insc" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
                        <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0m-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                        <path d="M2 13c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"/>
                    </svg> 
