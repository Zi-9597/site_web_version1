...
<head>
    ...
    <title>À propos de l'association - Association EEA</title>
...
<body>
  ...
  <!-- ===================== -->
    <header class="eea-header">
        <h1>Association des anciens et étudiants d’EEA</h1>
        <p>
  ...
  <!-- ===================== -->
    ...
    <div class="eea-wrapper">
        ...
        <section class="eea-presentation">
            ...
            <p>
                L’Association des anciens et étudiants d’EEA de l’Université de Lille a été
                ...
                de la filière <strong>Électronique, Énergie Électrique et Automatique (EEA)</strong>,
            ...
            <p>
                ...
                <strong>plusieurs étudiants et anciens de la filière EEA</strong>, engagés
                ...
                renforcer la dynamique du réseau EEA.
            </p>
        </section>
        ...
        <p>
            ...
            entre les étudiants et les anciens de la filière EEA. Elle cherche à
        ...
        <p>
            ...
            valorisation des parcours et compétences des membres de la filière EEA.
        </p>
        </section>
        ...
        <p>
            ...
            universitaire, contribuant ainsi à dynamiser la communauté EEA.
        </p>
        </section>
        ...
        <section class="eea-contact">
            ...
            <p>
                Étudiant(e) ou ancien(ne) de la filière EEA, vous souhaitez rejoindre
