...
<div class="logo_lille">
        <div class="u_lille">
            <img class="logo_ulille" src="public/pictures/logo_univ_5.png" alt="Logo Lille">
        </div>

        <div class="u_assoc">
            <img class="logo_assoc" src="public/pictures/logo_5.png" alt="Logo Assoc">
        </div>
</div>
    
<!--Gestion de la première barre de navagation du haut -->
<div class="nav_1" id="nav_1_id">

    <div class="reseau">
        <div class="sub_reseau">
            ...
            <a href="https://www.instagram.com/association_eea_univ_de_lille/" target="_blank" rel="noopener noreferrer"> 
            ...
            <a href="https://www.linkedin.com/company/93664607/admin/dashboard/" target="_blank" rel="noopener noreferrer"> 
...
<div class="nav_2" id="nav_2_id">
        ...
        <span> <a href="/?dest=depot_event"> Organiser un évènement </a> </span>
        <span> <a href="/?dest=rech_event"> Participer à un évènement </a> </span>
        <span> <a href="/?dest=depot_job"> Publier un job étudiant </a> </span>
        <span> <a href="/?dest=manage_job"> Gestion des offres </a> </span>
        <span> <a href="/?dest=manage_event"> Gestion des évenements </a> </span>
        <span> <a href="/?dest=manage_actualite"> Gestion des actualités </a> </span>
        <span> <a href="/?dest=manage_aides"> Gestion des aides étudiants </a> </span>
        <span> <a href="/?dest=manage_goodies"> Gestion des goodies </a> </span>
        <span> <a href="/?dest=manage_adherent"> Changement de status </a> </span>
