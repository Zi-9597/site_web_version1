document.addEventListener("DOMContentLoaded", () => {
    ...
    changeButtons.forEach(btn => {
        btn.addEventListener("click", async () => {
            ...
            console.log(data.data.date_creation);
            // Remplir modal
    ...
    /* ============================================================================
       💾 SUPRESSION DES OFFRES (UNIQUEMENT POUR L'INTERFACE DE GESTION DES OFRRES) 
       ET PAS LA PUBLICATION, CAR LE BOUTTON SUPPRIMER N'EXISTE DONC CET ÉVENEMENT NE 
       VAS JAMAIS AVOIR LIEU
    ============================================================================ */
