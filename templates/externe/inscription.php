...
<head>
    ...
    <link rel="stylesheet" href="public/css/inscription_st_v1.css">
    ...
    <form id="loginForm" action="/?dest=add_subscriber" method="POST">
        <div class="container-formulaire" id="container-formulaire-id">
            ...
            <div class="descritpion-inscription">
                <h1>Création d'un compte adhérent dans l'association Étudiant-Anciens EEA</h1>
                <div class='descirption-courte'>
                    <p>Votre compte <strong>Étudiant-Anciens EEA</strong> va vous permettre de :</p>
                    <ul>
                        <li>De trouver des offres de stages, d'alternance, d'emploi ainsi que des jobs étudiants vacants</li>
                        <li>De suivre les événements (activités ludiques, ...) qui vont se réaliser</li>
                        <li>De participer à des séances de révisions entre groupes</li>
                        <li>De vous remémorer des événements qui ont été faits durant l'année</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="formulaire-inscription" id="formulaire-id-inscription">
                ...
                <div class="formulaire-element" id="membre-section">
                    ...
                    <div id="element-section">
                        ...
                        <input type="text" id="autre-filiere" placeholder="Mettre votre ancienne filière" disabled>
                    </div>
                </div>
            ...
            <div class="button_submit">
                <button class="button_click" id="button_submit" type="submit">Validez votre inscription</button>
            </div>
        </div>
    </form>
