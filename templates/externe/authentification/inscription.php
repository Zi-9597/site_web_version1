...
<head>
    ...
    <link rel="stylesheet" href="public/css/inscription_st_v2.css?v=<?= filemtime('public/css/inscription_st_v2.css') ?>">
...
<body>
    ...
    <script src="public/js/inscription_v2.js?v=<?= filemtime('public/js/inscription_v2.js') ?>"></script>
