    ...
    <div id="modal-edit-event" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-field">
                    ...
                    <textarea
                        ...
                        rows="6"
                        maxlength="2500"
                        placeholder="Description de l’actualité (2500 caractères maximum)">
                    </textarea>
            ...
            <div class="modal-footer">
                ...
                <button class="modal-btn-save" id="btn-save-actu">Valider</button>
            </div>
    ...
    <div id="modal-add-actu" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Lien actualité -->
                <div class="modal-field">
                    <label>Lien de l’actualité :</label>
                    <input 
                        type="text" 
                        id="add-lien-actu"
                        maxlength="50"
                        placeholder="Ex : https://eea-association.fr/actualite">
                </div>
                ...
                <div class="modal-field">
                    ...
                    <textarea 
                        ...
                        rows="6"
                        maxlength="2500"
                        placeholder="Description détaillée de l’actualité (2500 caractères max)">
                    </textarea>
            ...
            <div class="modal-footer">
                ...
                <button class="modal-btn-save" id="btn-add-actu">
                    Ajouter
                </button>
            </div>
